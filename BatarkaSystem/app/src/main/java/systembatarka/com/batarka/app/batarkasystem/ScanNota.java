...
public class ScanNota extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = (Button) findViewById(R.id.qrScan2);
...
// Write a string when this client loses connection
        ...
        connectedRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                if (connected) {
                    final Cursor cursor;
                    cursor = dbHelperScanedIDs.getOrder(4);
                    try {
                                    ...
                                    query.addValueEventListener(new com.firebase.client.ValueEventListener() {
                                        ...
                                        public void onDataChange(com.firebase.client.DataSnapshot dataSnapshot) {
                                            ...
                                            try {
                                                ...
                                                if (isTagawob) {
                                                    dbHelperScanedIDs.deleteOrder(cursor.getInt(0), 4);
                                                }
                                            }catch (Exception e){
                ...
                query.addValueEventListener(new com.firebase.client.ValueEventListener() {
                    ...
                    public void onDataChange(com.firebase.client.DataSnapshot dataSnapshot) {
                        ...
                        try {
                            ...
                            MainActivity.myFirebaseRef.child("Classes").child(myOwnClass).child("m5dumin").child(rawResult.getText()).child("Points").child(sharedPref.getString("LastWeekDate", "")).child("Nota").setValue(true);
                            ...
                            dbHelperScanedIDs.addOrder(Integer.parseInt(rawResult.getText().toString()),3);
