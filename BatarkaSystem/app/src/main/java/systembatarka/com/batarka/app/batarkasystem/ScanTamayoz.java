...
public class ScanTamayoz extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_tamayoz);
        Button button = (Button) findViewById(R.id.qrScan5);
...
// Write a string when this client loses connection
        ...
        connectedRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                if (connected) {
                    final Cursor cursor;
                    cursor = dbHelperScanedIDs.getOrder(6);
                    try {
                                    ...
                                    query.addValueEventListener(new com.firebase.client.ValueEventListener() {
                                        ...
                                        public void onDataChange(com.firebase.client.DataSnapshot dataSnapshot) {
                                            ...
                                            try {
                                                ...
                                                if (isTagawob) {
                                                    dbHelperScanedIDs.deleteOrder(cursor.getInt(0), 6);
                                                }
                                            }catch (Exception e){
                ...
                query.addValueEventListener(new com.firebase.client.ValueEventListener() {
                    ...
                    public void onDataChange(com.firebase.client.DataSnapshot dataSnapshot) {
                        ...
                        try {
                            ...
                            dbHelperScanedIDs.addOrder(Integer.parseInt(rawResult.getText().toString()),6);
