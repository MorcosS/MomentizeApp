...
public class ScanTanawol extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_tanawol);
        Button button = (Button) findViewById(R.id.qrScan3);
...
// Write a string when this client loses connection
        ...
        connectedRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                if (connected) {
                    final Cursor cursor;
                    cursor = dbHelperScanedIDs.getOrder(3);
                    try {
                                    ...
                                    query.addValueEventListener(new com.firebase.client.ValueEventListener() {
                                        ...
                                        public void onDataChange(com.firebase.client.DataSnapshot dataSnapshot) {
                                            ...
                                            try {
                                                ...
                                                if (isTagawob) {
                                                    dbHelperScanedIDs.deleteOrder(cursor.getInt(0), 3);
                                                }
                                            }catch (Exception e){
