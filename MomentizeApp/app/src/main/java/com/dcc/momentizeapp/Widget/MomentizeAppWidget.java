...
public class MomentizeAppWidget  extends AppWidgetProvider {
    /**
     * this method is called every 30 mins as specified on widgetinfo.xml
     * this method is also called on every phone reboot
     **/

    public static final String ACTION_DATA_UPDATED = "com.dcc.momentizeapp.ACTION_DATA_UPDATED";
    @Override
 ...
 * your homescreen*/
    ...
    private RemoteViews updateWidgetListView(Context context,
        ...
        RemoteViews remoteViews = new RemoteViews(
                context.getPackageName(),R.layout.memory_widget_list);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(ACTION_DATA_UPDATED)) {
            ...
            int[] ids = gm.getAppWidgetIds(new ComponentName(context, MomentizeAppWidget.class));
